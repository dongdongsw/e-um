  ...
  <span>${detail_vo.b_view_count}</span> <!-- 조회수 -->
      ...
      <div class="contact-bar">
        <div style="display: flex;">
           <div class="avatar" style="margin-right: 10px; overflow: hidden;">
    ...
    <div class="hero-right">
       <!--컨텐츠 메인 이미지 -->
        <img src="${board_vo.b_thumbnail }" style="width: 100%; height: 100%; border-radius: 16px">
    </div>
  </section>
  <!-- 상세정보 시작 --> 
          ...
          <aside class="side-sticky">
            <c:forEach var="rvo" items="${review_vo}">
              <div class="re-card" id="reviews">
                <div class="review">
                  <div style="display: flex;">
                    <div class="avatar" style="margin-right: 10px;"><img src="${rvo.uvo.u_profileimg_url }" style="border-radius: 50px"></div> <!-- 리뷰 프로필 -->
                    <div>
       ...
       <form class="price-form" method="post" action="../main/orders.eum">
        ...
        <div class="menu">
          <c:forEach var="price" items="${price_vo}">
            <input type="radio" name="b_op_id" value="${price.b_op_id}" id="sort-${price.b_op_id}">
