  ...
  <section class="dt-container hero" id="main-section">
    <div class="hero-left">
      ...
      <div class="meta" aria-label="별점 및 관심">
        ...
        <span class="rating">${vo.b_review_score}</span> <!-- 컨텐츠 평점 -->
  ...
  <section class="dt-container hero">
    <div class="hero-left">
      <div id="tabs" style="background-color: #fff; border: none;">
        ...
        <div id="tabs-1">
   		  <br>
   		  <p style="font-weight: 600">작업 방식 : ${vo.b_prod_on_off eq "OFFLINE"?'비대면':'대면'}</p> <!-- ONLINE => 비대면 / OFFLINE => 대면 -->
   		  <br>
          ...
          <aside class="side-sticky">
            <c:forEach begin="0" end="5">
              <div class="re-card" id="reviews">
				...
				<!-- 리뷰 내용 -->
                <p style="margin:0; color:var(--muted)">${vo.b_review_content}</p>
