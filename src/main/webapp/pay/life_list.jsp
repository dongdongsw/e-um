       ...
       <c:forEach var="vo" items="${life_list }">
         <div class="col-md-3">
		   <div class="temporary__storage" style="border:none">
			  <div class="list-card" onclick="location.href='../main/life_detail.eum?b_id=${vo.b_id}'">
			    <div class="image">
  ...
  <ul class="page">
    <c:if test="${startPage>1}">
      <li class="page__btn active">
        <a class="material-icons" href="../main/life_list.eum?page=${startPage-1}">&lt;</a>
      </li>
    </c:if>
    <c:forEach var="i" begin="${startPage}" end="${endPage}">
      <li class="page__numbers ${i==curpage?'active':''}">
        <a href="../main/life_list.eum?page=${i}">${i}</a>
      </li>
    </c:forEach>
    <c:if test="${endPage<totalpage}">
      <li class="page__btn active">
        <a class="material-icons" href="../main/life_list.eum?page=${endPage+1}">&gt;</a>
      </li>
    </c:if>
  </ul>
</div>
