          ...
          <ul class="page">
            <c:if test="${startPage > 1}">
              <li class="page__btn active">
                <a href="../content/talent_list.eum?page=${startPage-1}&b_type=비즈니스">&lt;</a>
              </li>
            </c:if>
            <c:forEach var="i" begin="${startPage}" end="${endPage}">
              <li class="page__numbers ${i==curpage?'active':''}">
                <a href="../content/talent_list.eum?page=${i}&b_type=비즈니스">${i}</a>
              </li>
            </c:forEach>
            <c:if test="${endPage < totalpage}">
              <li class="page__btn active">
                <a href="../content/talent_list.eum?page=${endPage+1}&b_type=비즈니스">&gt;</a>
              </li>
            </c:if>
          </ul>
        </div>
