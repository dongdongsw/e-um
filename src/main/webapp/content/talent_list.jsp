...
<div class="category-tabs">
    <div class="category-tabs-container" style="text-align: center;">
        <ul style="display: inline-flex; gap: 50px;">
			...
			<li><a href="../content/talent_list.eum?b_type=생활라이프" class="active">생활/라이프</a></li>
          ...
          <ul class="page">
            <c:if test="${startPage > 1}">
              <li class="page__btn active">
                <a href="../content/talent_list.eum?page=${startPage-1}&b_type=생활라이프">&lt;</a>
              </li>
            </c:if>
            <c:forEach var="i" begin="${startPage}" end="${endPage}">
              <li class="page__numbers ${i==curpage?'active':''}">
                <a href="../content/talent_list.eum?page=${i}&b_type=생활라이프">${i}</a>
              </li>
            </c:forEach>
            <c:if test="${endPage < totalpage}">
              <li class="page__btn active">
                <a href="../content/talent_list.eum?page=${endPage+1}&b_type=생활라이프">&gt;</a>
              </li>
            </c:if>
          </ul>
        </div>
