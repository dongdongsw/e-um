...
/* 버튼 공통 (기존 유지) */
.btn {
  padding:8px 12px; border:1px solid #e5e7eb; border-radius:8px; background-color: #111111; cursor:pointer; width: 100px; color:#ffffff;
}
.btn:hover { 
          ...
          <c:forEach var="vo" items="${list}">
            <div class="content-item">
              ...
              <div class="content-info" style="flex:1;">
                <!-- 제목: 한 줄 말줄임 -->
                <div class="content-title one-line">${vo.bvo.b_title}</div>
                ...
                <div class="content-meta" style="display:flex; align-items:center; gap:8px;">
                  ...
                  <span class="dot">·</span>
                  <span><fmt:formatDate value="${vo.b_review_createdat}" pattern="yyyy.MM.dd HH:mm" /></span>
                </div>
                ...
                <div class="stars">
                  ...
                  <span class="score">${vo.b_review_score}</span>
                </div>

                <!-- 리뷰 본문: 두 줄 말줄임 -->
                <div class="clamp-2" style="color:#333;">${vo.b_review_content}</div>
             ...
             <div class="content-actions vertical">
			  <button type="button" class="btn"
			    onclick="location.href='../etc/detail.eum?b_id=${vo.bvo.b_id}'">자세히 보기</button>
