					...
					<div class="row mb-4 items-align-center">
						<div
							...
							<div class="position-relative" style="width: 350px;">
								<span class="fe fe-search position-absolute text-muted"
									style="top: 8px; left: 14px;"></span> <input
									...
									<td class="align-center">
										<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input"
												id="check${vo.n_id}" value="${vo.n_id}"
												onclick="event.stopPropagation();"> <label
												class="custom-control-label" for="check${vo.n_id}"></label>
										</div>
									</td>
									<td>${vo.n_id}</td>
									<td style="cursor: pointer;"
										onclick="location.href='../admin/admin_notice_detail.eum?n_id=${vo.n_id}'">${vo.n_title}</td>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item"
													onclick="location.href='admin_notice_update.eum?n_id=${vo.n_id}'">수정</a>
												<a class="dropdown-item" href="#" data-toggle="modal"
													data-target="#deleteModal" data-id="${vo.n_id}">삭제</a>
											</div>
										</div>
									</td>
								</tr>
