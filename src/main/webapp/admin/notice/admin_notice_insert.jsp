							...
							<form method="post" action="admin_notice_insert_ok.eum">
								<div class="form-group mb-3">
									<label for="title"><strong>제목</strong></label> <input
										type="text" id="title" name="n_title"
										placeholder="공지 제목을 입력하세요" required>
								</div>
								<div class="form-group mb-3">
									<label for="content"><strong>내용</strong></label>
									<textarea id="content" name="n_content"
										placeholder="공지 내용을 입력하세요" required></textarea>
								</div>
								<!-- 첨부 파일 -->
								<div class="form-group mb-3">
									<label for="upload"><strong>첨부파일</strong></label> <input
										type="file" id="upload" name="uploadFile" class="form-control"
										multiple style="height: 50px"> <small
										class="form-text text-muted">※ 여러 파일을 업로드하려면 Ctrl(또는
										Command) 키를 누르고 선택하세요.</small>
								</div>
								<div class="btn-wrap">
