						...
						<div class="card shadow mb-4">
							<div class="card-body">
								...
								<div class="form-group">
									<label for="n_title"><strong>제목</strong></label> <input
										type="text" id="n_title" name="n_title" class="form-control"
								...
								<div class="form-group mt-4">
									...
									<textarea id="n_content" name="n_content" class="form-control"
										rows="22" required>${vo.n_content}</textarea>
								</div>
								<!-- 버튼 -->
								<div class="card-footer">
									<div class="d-flex justify-content-between">
										<button type="button" class="btn btn-secondary"
											onclick="location.href='admin_notice_list.eum'">
										...
										<div>
											...
											<button type="button" class="btn btn-outline-danger"
												onclick="location.href='admin_notice_detail.eum?n_id=${vo.n_id}'">
